		...
		! function(e, t) {
			...
			n("moxie/core/utils/Basic", [], function() {
					...
					return o.OS = o.os, a && (o.debug = {
						...
						var t = arguments[0];
						if("string" === e.typeOf(t) && (t = e.sprintf.apply(this, arguments)), window && window.console && window.console.log);
						else if(document) {
	...
	! function(global) {
		...
		function QiniuJsSDK() {
			function log(e, t) {
				...
				that.detectIEVersion() ? console.log(n) : (t.unshift(i)), document.getElementById("qiniu-js-sdk-log") && (document.getElementById("qiniu-js-sdk-log").innerHTML += "<p>" + n + "</p>")
			}
