...
var page = x_url;
            ...
            var s=encodeURIComponent(res.key)
           
            deleteimg.attr('data-key', url).attr('data-name', '123').text('删除');
            ...
            deleteimg.on('click', function () {
                ...
                $.ajax({
                    type: "post",
                    url: page + "holidaywork/student/deleteTaskImg?" + Math.random(),
                    dataType: "json",
                    data: {token:pcToken, classId: classId, path:key, taskId: taskId,stuId:stuId},
