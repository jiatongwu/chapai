...
<div id="addApp"  style="padding: 10px 10px;">
    <form class="layui-form layui-form-pane">
        <input name="id" value="${smsTemplate.id}" hidden/>
        <div class="layui-form-item">
            <label class="layui-form-label">模板名称</label>
            <div class="layui-input-inline">
                <input type="text" name="name"
                       value="${smsTemplate.name}" lay-verify="required"
        ...
        <div class="layui-form-item layui-form-text">
            ...
            <div class="layui-input-block">
                <textarea name="content" placeholder="请输入短信模板" lay-verify="required"
                          class="layui-textarea">${smsTemplate.content}</textarea>
            </div>
        </div>
        <div class="layui-form-item">
...
<script src="${pageContext.request.contextPath }/static/js/smsTemplate/smsTemplate_editPage.js"></script>
<script>
</script>
</html>
