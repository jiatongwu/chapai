...
public interface UserTableDynamicSqlMapper {
    ...
    default QueryExpressionDSL<MyBatis3SelectModelAdapter<List<UserTable>>> selectByExample() {
        return SelectDSL.selectWithMapper(this::selectMany, id, username, password, name, extend, type, salt)
                .from(userTable);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2019-07-05T20:12:44.878+08:00", comments="Source Table: user_table")
    default QueryExpressionDSL<MyBatis3SelectModelAdapter<List<UserTable>>> selectDistinctByExample() {
        return SelectDSL.selectDistinctWithMapper(this::selectMany, id, username, password, name, extend, type, salt)
                .from(userTable);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2019-07-05T20:12:44.878+08:00", comments="Source Table: user_table")
    default UserTable selectByPrimaryKey(Integer id_) {
        return SelectDSL.selectWithMapper(this::selectOne, id, username, password, name, extend, type, salt)
                .from(userTable)
                .where(id, isEqualTo(id_))
                .build()
                .execute();
