...
public final class SerdoorselectschemeDynamicSqlSupport {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2019-07-31T15:28:01.172+08:00", comments="Source field: SerDoorSelectScheme.SchId")
    public static final SqlColumn<Integer> schid = serdoorselectscheme.schid;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2019-07-31T15:28:01.172+08:00", comments="Source field: SerDoorSelectScheme.SchName")
    public static final SqlColumn<String> schname = serdoorselectscheme.schname;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2019-07-31T15:28:01.172+08:00", comments="Source field: SerDoorSelectScheme.FieldName")
    public static final SqlColumn<String> fieldname = serdoorselectscheme.fieldname;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2019-07-31T15:28:01.172+08:00", comments="Source field: SerDoorSelectScheme.Operators")
    public static final SqlColumn<String> operators = serdoorselectscheme.operators;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2019-07-31T15:28:01.172+08:00", comments="Source field: SerDoorSelectScheme.Selectvalues")
    public static final SqlColumn<String> selectvalues = serdoorselectscheme.selectvalues;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2019-07-31T15:28:01.172+08:00", comments="Source field: SerDoorSelectScheme.startime")
    public static final SqlColumn<String> startime = serdoorselectscheme.startime;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2019-07-31T15:28:01.172+08:00", comments="Source field: SerDoorSelectScheme.endtime")
