...
public interface LogDynamicSqlMapper {
    ...
    @Results(id="LogResult", value = {
        ...
        @Result(column="option_details", property="optionDetails", jdbcType=JdbcType.CLOB)
    })
    List<Log> selectMany(SelectStatementProvider selectStatement);

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2019-07-14T17:27:27.976+08:00", comments="Source Table: log")
    ...
    default int insert(Log record) {
        return insert(SqlBuilder.insert(record)
                ...
                .map(optionName).toProperty("optionName")
                .map(createtime).toProperty("createtime")
                .map(userAgent).toProperty("userAgent")
                .map(clientId).toProperty("clientId")
                .map(optionDetails).toProperty("optionDetails")
                .build()
    ...
    default int insertSelective(Log record) {
        return insert(SqlBuilder.insert(record)
                ...
                .map(optionName).toPropertyWhenPresent("optionName", record::getOptionName)
                ...
                .map(optionDetails).toPropertyWhenPresent("optionDetails", record::getOptionDetails)
                .build()
                .render(RenderingStrategy.MYBATIS3));
    }
    ...
    default QueryExpressionDSL<MyBatis3SelectModelAdapter<List<Log>>> selectByExample() {
        return SelectDSL.selectWithMapper(this::selectMany, id, userId, optionName, createtime, userAgent, clientId, optionDetails)
                .from(log);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2019-07-14T17:27:27.976+08:00", comments="Source Table: log")
    default QueryExpressionDSL<MyBatis3SelectModelAdapter<List<Log>>> selectDistinctByExample() {
        return SelectDSL.selectDistinctWithMapper(this::selectMany, id, userId, optionName, createtime, userAgent, clientId, optionDetails)
                .from(log);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2019-07-14T17:27:27.976+08:00", comments="Source Table: log")
    default Log selectByPrimaryKey(Integer id_) {
        return SelectDSL.selectWithMapper(this::selectOne, id, userId, optionName, createtime, userAgent, clientId, optionDetails)
                .from(log)
                .where(id, isEqualTo(id_))
                .build()
                .execute();
    ...
    default UpdateDSL<MyBatis3UpdateModelAdapter<Integer>> updateByExample(Log record) {
        return UpdateDSL.updateWithMapper(this::update, log)
                ...
                .set(optionName).equalTo(record::getOptionName)
                .set(createtime).equalTo(record::getCreatetime)
                .set(userAgent).equalTo(record::getUserAgent)
                .set(clientId).equalTo(record::getClientId)
                .set(optionDetails).equalTo(record::getOptionDetails);
    }
    ...
    default UpdateDSL<MyBatis3UpdateModelAdapter<Integer>> updateByExampleSelective(Log record) {
        return UpdateDSL.updateWithMapper(this::update, log)
                ...
                .set(optionName).equalToWhenPresent(record::getOptionName)
                .set(createtime).equalToWhenPresent(record::getCreatetime)
                .set(userAgent).equalToWhenPresent(record::getUserAgent)
                .set(clientId).equalToWhenPresent(record::getClientId)
                .set(optionDetails).equalToWhenPresent(record::getOptionDetails);
    }
