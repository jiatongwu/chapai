...
public final class ZhPersonDynamicSqlSupport {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2019-07-14T17:27:27.968+08:00", comments="Source field: zh_Person.id")
    public static final SqlColumn<Integer> id = zhPerson.id;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2019-07-14T17:27:27.968+08:00", comments="Source field: zh_Person.userNo")
    public static final SqlColumn<String> userno = zhPerson.userno;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2019-07-14T17:27:27.968+08:00", comments="Source field: zh_Person.userName")
    public static final SqlColumn<String> username = zhPerson.username;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2019-07-14T17:27:27.968+08:00", comments="Source field: zh_Person.sex")
    public static final SqlColumn<String> sex = zhPerson.sex;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2019-07-14T17:27:27.968+08:00", comments="Source field: zh_Person.homeAddress")
    public static final SqlColumn<String> homeaddress = zhPerson.homeaddress;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2019-07-14T17:27:27.968+08:00", comments="Source field: zh_Person.mobNumber")
    public static final SqlColumn<String> mobnumber = zhPerson.mobnumber;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2019-07-14T17:27:27.968+08:00", comments="Source field: zh_Person.carSpalcesNum")
