...
import static cn.xvkang.primarymapperdynamicsql.MyrecordqueryDynamicSqlSupport.*;

import cn.xvkang.primaryentity.Myrecordquery;
...
@Mapper
public interface MyrecordqueryDynamicSqlMapper {
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2019-07-05T20:12:44.636+08:00", comments="Source Table: MYRECORDQUERY")
    ...
    int insert(InsertStatementProvider<Myrecordquery> insertStatement);

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2019-07-05T20:12:44.636+08:00", comments="Source Table: MYRECORDQUERY")
    @SelectProvider(type=SqlProviderAdapter.class, method="select")
    @Results(id="MyrecordqueryResult", value = {
    ...
    List<Myrecordquery> selectMany(SelectStatementProvider selectStatement);

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2019-07-05T20:12:44.640+08:00", comments="Source Table: MYRECORDQUERY")
    ...
    default DeleteDSL<MyBatis3DeleteModelAdapter<Integer>> deleteByExample() {
        return DeleteDSL.deleteFromWithMapper(this::delete, myrecordquery);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2019-07-05T20:12:44.640+08:00", comments="Source Table: MYRECORDQUERY")
    default int insert(Myrecordquery record) {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2019-07-05T20:12:44.640+08:00", comments="Source Table: MYRECORDQUERY")
    default int insertSelective(Myrecordquery record) {
        return insert(SqlBuilder.insert(record)
                .into(myrecordquery)
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2019-07-05T20:12:44.640+08:00", comments="Source Table: MYRECORDQUERY")
    default QueryExpressionDSL<MyBatis3SelectModelAdapter<List<Myrecordquery>>> selectByExample() {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2019-07-05T20:12:44.640+08:00", comments="Source Table: MYRECORDQUERY")
    default QueryExpressionDSL<MyBatis3SelectModelAdapter<List<Myrecordquery>>> selectDistinctByExample() {
        return SelectDSL.selectDistinctWithMapper(this::selectMany, id, cardno, cph, cardtype, intime, outtime, ingatename, outgatename, inoperatorcard, outoperatorcard, inoperator, outoperator, inpic, inuser, outpic, outuser, zjpic, sfje, balance, ysje, sftime, sfoperator, sfoperatorcard, sfgate, overtimesymbol, overtimesftime, overtimesfje, carparkno, bigsmall, freereason, staytime, temp1, temp2, temp3, temp4, temp5, bmorepaingcar, bdz, strdz)
                .from(myrecordquery);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2019-07-05T20:12:44.640+08:00", comments="Source Table: MYRECORDQUERY")
    default UpdateDSL<MyBatis3UpdateModelAdapter<Integer>> updateByExample(Myrecordquery record) {
        return UpdateDSL.updateWithMapper(this::update, myrecordquery)
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2019-07-05T20:12:44.641+08:00", comments="Source Table: MYRECORDQUERY")
    default UpdateDSL<MyBatis3UpdateModelAdapter<Integer>> updateByExampleSelective(Myrecordquery record) {
        return UpdateDSL.updateWithMapper(this::update, myrecordquery)
