...
public final class MyiclostDynamicSqlSupport {
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2019-07-05T20:12:44.575+08:00", comments="Source Table: MYICLOST")
    public static final Myiclost myiclost = new Myiclost();

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2019-07-05T20:12:44.575+08:00", comments="Source field: MYICLOST.CardNO")
    public static final SqlColumn<String> cardno = myiclost.cardno;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2019-07-05T20:12:44.575+08:00", comments="Source field: MYICLOST.LossregDate")
    public static final SqlColumn<Date> lossregdate = myiclost.lossregdate;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2019-07-05T20:12:44.575+08:00", comments="Source field: MYICLOST.OperatorCardNO")
    public static final SqlColumn<String> operatorcardno = myiclost.operatorcardno;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2019-07-05T20:12:44.575+08:00", comments="Source field: MYICLOST.CardState")
    public static final SqlColumn<String> cardstate = myiclost.cardstate;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2019-07-05T20:12:44.575+08:00", comments="Source field: MYICLOST.CarLostOKID")
    public static final SqlColumn<String> carlostokid = myiclost.carlostokid;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2019-07-05T20:12:44.575+08:00", comments="Source field: MYICLOST.CarLostOKNO")
    public static final SqlColumn<Boolean> carlostokno = myiclost.carlostokno;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2019-07-05T20:12:44.575+08:00", comments="Source field: MYICLOST.CarUnLostOKNO")
    public static final SqlColumn<Boolean> carunlostokno = myiclost.carunlostokno;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2019-07-05T20:12:44.575+08:00", comments="Source field: MYICLOST.MJLostOKID")
