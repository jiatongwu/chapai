...
public final class SelectlossschemeDynamicSqlSupport {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2019-07-14T17:27:27.912+08:00", comments="Source field: SelectLossScheme.SchId")
    public static final SqlColumn<Integer> schid = selectlossscheme.schid;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2019-07-14T17:27:27.912+08:00", comments="Source field: SelectLossScheme.SchName")
    public static final SqlColumn<String> schname = selectlossscheme.schname;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2019-07-14T17:27:27.912+08:00", comments="Source field: SelectLossScheme.FieldName")
    public static final SqlColumn<String> fieldname = selectlossscheme.fieldname;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2019-07-14T17:27:27.912+08:00", comments="Source field: SelectLossScheme.Operators")
    public static final SqlColumn<String> operators = selectlossscheme.operators;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2019-07-14T17:27:27.912+08:00", comments="Source field: SelectLossScheme.Selectvalues")
    public static final SqlColumn<String> selectvalues = selectlossscheme.selectvalues;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2019-07-14T17:27:27.912+08:00", comments="Source field: SelectLossScheme.startime")
    public static final SqlColumn<String> startime = selectlossscheme.startime;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2019-07-14T17:27:27.912+08:00", comments="Source field: SelectLossScheme.endtime")
