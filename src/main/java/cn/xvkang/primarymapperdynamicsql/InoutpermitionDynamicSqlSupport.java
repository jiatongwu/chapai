...
public final class InoutpermitionDynamicSqlSupport {
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2019-07-18T14:55:17.607+08:00", comments="Source Table: InOutPermition")
    public static final Inoutpermition inoutpermition = new Inoutpermition();

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2019-07-18T14:55:17.607+08:00", comments="Source field: InOutPermition.ID")
    public static final SqlColumn<Integer> id = inoutpermition.id;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2019-07-18T14:55:17.608+08:00", comments="Source field: InOutPermition.CtrlNumbers")
    public static final SqlColumn<String> ctrlnumbers = inoutpermition.ctrlnumbers;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2019-07-18T14:55:17.608+08:00", comments="Source field: InOutPermition.CardTypes")
    public static final SqlColumn<String> cardtypes = inoutpermition.cardtypes;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2019-07-18T14:55:17.608+08:00", comments="Source field: InOutPermition.WeekDays")
    public static final SqlColumn<String> weekdays = inoutpermition.weekdays;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2019-07-18T14:55:17.608+08:00", comments="Source field: InOutPermition.TimeBegin")
    public static final SqlColumn<Date> timebegin = inoutpermition.timebegin;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2019-07-18T14:55:17.608+08:00", comments="Source field: InOutPermition.TimeEnd")
