...
public final class MyshoufeiguangzouDynamicSqlSupport {
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2019-07-18T14:55:17.750+08:00", comments="Source Table: MYSHOUFEIGUANGZOU")
    public static final Myshoufeiguangzou myshoufeiguangzou = new Myshoufeiguangzou();

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2019-07-18T14:55:17.750+08:00", comments="Source field: MYSHOUFEIGUANGZOU.CardType")
    public static final SqlColumn<String> cardtype = myshoufeiguangzou.cardtype;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2019-07-18T14:55:17.750+08:00", comments="Source field: MYSHOUFEIGUANGZOU.FreeMark")
    public static final SqlColumn<Integer> freemark = myshoufeiguangzou.freemark;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2019-07-18T14:55:17.750+08:00", comments="Source field: MYSHOUFEIGUANGZOU.FreeTime")
    public static final SqlColumn<Integer> freetime = myshoufeiguangzou.freetime;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2019-07-18T14:55:17.750+08:00", comments="Source field: MYSHOUFEIGUANGZOU.SFCycle")
    public static final SqlColumn<Integer> sfcycle = myshoufeiguangzou.sfcycle;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2019-07-18T14:55:17.750+08:00", comments="Source field: MYSHOUFEIGUANGZOU.TimePeriod")
    public static final SqlColumn<Integer> timeperiod = myshoufeiguangzou.timeperiod;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2019-07-18T14:55:17.750+08:00", comments="Source field: MYSHOUFEIGUANGZOU.WithinPeriodSF")
    public static final SqlColumn<BigDecimal> withinperiodsf = myshoufeiguangzou.withinperiodsf;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2019-07-18T14:55:17.750+08:00", comments="Source field: MYSHOUFEIGUANGZOU.WithoutPeriodSF")
